  ...
  return (
    <section className="relative py-16 lg:py-24 bg-canvas border-t border-line">
      <div className="container-x">
        ...
        {hasData ? (
          <FadeStagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5" staggerDelay={0.1}>
            {items.map((it) => (
              <FadeStaggerItem key={it.id} y={16} className="rounded-lg bg-paper border border-line p-7 flex flex-col min-h-[240px]">
          ...
          <FadeUp className="rounded-lg bg-paper border border-dashed border-line p-10 lg:p-16 text-center">
