    ...
    <section id="about" className="relative pt-20 lg:pt-28 bg-canvas border-t border-line pb-16">
      <div className="container-x">
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <FadeUp className="relative rounded-lg overflow-hidden aspect-[4/3] bg-muted order-1" y={20}>
            <img
          ...
          <FadeStagger className="order-2" staggerDelay={0.1}>
            <FadeStaggerItem as="p" className="text-base text-steel leading-relaxed">
              {t('about.p1')}
            </FadeStaggerItem>
            <FadeStaggerItem as="p" className="mt-4 text-base text-steel leading-relaxed">
              {t('about.p2')}
            </FadeStaggerItem>

            <FadeStaggerItem className="mt-8 flex flex-wrap gap-3">
        ...
        <FadeStagger className="mt-16 lg:mt-20 pt-12 border-t border-line grid grid-cols-1 sm:grid-cols-3 gap-8" staggerDelay={0.08}>
          {stats.map(({ icon: Icon, label }) => (
            <FadeStaggerItem key={label} className="flex items-center gap-4 justify-center sm:justify-start">
